...
function(build_flatbuffers flatbuffers_schemas
  ...
  foreach(schema ${flatbuffers_schemas})
    ...
    if (NOT ${generated_includes_dir} STREQUAL "")
      ...
      MESSAGE("--- generating: include ${generated_include}")
      MESSAGE("--- generating: dir: ${generated_includes_dir}")
      MESSAGE("--- generating: file: ${filename}")
      MESSAGE("--- generating: target: ${FLATC_TARGET}")
      MESSAGE("--- generating: flatc: ${FLATC}")
      add_custom_command(
